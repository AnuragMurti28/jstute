...
console.log("using substring() function returns the elements at index passed in function if string have substring as passed value(1,11) in function: ", html.substring(0, 11));
...
console.log("using slice() function returns the elements from range index passed in function if string have substring as passed value(1,9) in function: ", html.slice(1, 9));
